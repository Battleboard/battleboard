    ...
    return <div style = {{display: "flex", height: "80vh", margin:0,padding:0}}>
        <div style={{textAlign:"center",position:"relative",height: "100px",width: "100vw",backgroundColor: "#333",position: "absolute",top: "0px",margin: 80, marginLeft:0}}>
            ...
            <div style = {{margin:10, marginLeft:0, padding: 0}}></div>
                <div style = {{display: "flex", flexWrap: "wrap", width: "40vh", height: "50vh",marginTop:115}}>
                ...
                <div style={{textAlign:"center",position: "relative",height: "200px",width: "100vw",backgroundColor: "#333",position: "absolute",bottom: "0px"}}>
